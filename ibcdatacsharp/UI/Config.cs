...
namespace ibcdatacsharp.UI
{
    public static class Config
    {
        ...
        +"\n";
        public const string csvHeader2IMUs = @"DEFAULT	DEFAULT	DEFAULT	DEFAULT	DEFAULT	DEFAULT	DEFAULT	DEFAULT	DEFAULT	DEFAULT	DEFAULT	DEFAULT	DEFAULT	DEFAULT
            TIME	TIME	X_ANGLE	Y_ANGLE	Z-ANGLE ANGV ANGA	
